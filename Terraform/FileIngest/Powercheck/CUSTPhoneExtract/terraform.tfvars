...
# Dataflow
#
job_name = "ngm-dataflow-powercheck-cust-phone"
max_workers = 1
on_delete = "cancel"
...
job_parameters =
    {
      inputFilePattern = "gs://ngm-tier3-files/powercheck/cust_phone_extract*",
      JSONPath = "gs://ngm-dataflow/cust_phone_extract/files/cust_phone_extract-schema.json",
      javascriptTextTransformGcsPath = "gs://ngm-dataflow/cust_phone_extract/files/csv-to-bq.js",
      ...
      outputTable = "northgate-data-lake:powercheck.cust_phone_extract"
    }
...
object_list = [
  {
    source = "files/cust_phone_extract-schema.json",
    destination = "cust_phone_extract/files/cust_phone_extract-schema.json"
  },
  {
    source = "files/csv-to-bq.js",
    destination = "cust_phone_extract/files/csv-to-bq.js"      
  }
]
