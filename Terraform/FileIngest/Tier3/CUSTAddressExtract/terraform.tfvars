...
# Dataflow
#
job_name = "ngm-dataflow-tier3-cust-address"
...
job_parameters = {
  inputFilePattern                  = "gs://ngm-tier3-files/tier3/cust_address_extract*"
  JSONPath                          = "gs://ngm-dataflow/cust_address_extract/files/cust_address_extract-schema.json"
  outputTable                       = "northgate-data-lake:tier3.cust_address_extract"
  bigQueryLoadingTemporaryDirectory = "gs://ngm-dataflow/tmp"
  outputDeadletterTable             = "northgate-data-lake:tier3.cust_address_extract_errors"
}
